...
const Pagination: React.FC<{
  ...
  return (
    <div className="flex flex-row justify-end items-center p-2 lg:p-4 gap-2 sm:gap-12">
      ...
      <div className="flex flex-row">
        ...
        <span className="flex items-center text-nowrap text-xs sm:text-sm md:text-md lg:text-lg">
